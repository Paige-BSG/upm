...
const nimbusConfig = defineNimbusConfig({
  // UPM's canonical origin (no trailing slash). Assumed host: GitHub Pages for
  // this account. Nimbus 0.x treats site as an origin and drops any path, so a
  // project-site prefix (e.g. /upm) is not reflected here. Update when the real
  // deploy origin is fixed.
  site: "https://paige-bsg.github.io",
